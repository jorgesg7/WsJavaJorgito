...
public class HiloCalculoPrimo implements Runnable{
	...
	@Override
	public void run() {
		System.out.println(nombre + "  -  calculando si el numero " + numeroPrimo + " es primo...");
		//tomamos el tiempo inicial
		// la clase date vuando instanciemos el objeto
		...
		System.out.println("Hilo: " + nombre + " , es el numero" + numeroPrimo + " Primo?:" + esPrimo);
		//syso de abajo es el del tiempo
		System.out.println("Hilo: " + nombre + ", el tiempo total "+ "del calculo del numero ha sido " + tiempoTranscurrido);
	}
